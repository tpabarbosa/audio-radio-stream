...
describe("#View - test suite for presentation layer", () => {
    ...
    function makeClassListElement({ classes } = {
        classes: [],
    }) {
    ...
    describe("changeCommandButtonsVisibility", () => {
        test("given hide=true it should add unassigned class and reset onclick", () => {
            const view = new View();
        ...
        test("given hide=false it should remove unassigned class and reset click", () => {
            const view = new View();
            const btn = makeBtnElement();
            jest.spyOn(document, "querySelectorAll").mockReturnValue([btn]);
